...
if uploaded_file:
    ...
    while cap.isOpened():
        ...
        # Wrap frame into MediaPipe Image with dimensions (fixes warnings)
        mp_image = Image(
        ...
        if result.pose_landmarks:
            ...
            # Example: Calculate peak hip angle (simplified)
            left_hip = result.pose_landmarks.landmark[PoseLandmark.LEFT_HIP]
            left_knee = result.pose_landmarks.landmark[PoseLandmark.LEFT_KNEE]
            left_shoulder = result.pose_landmarks.landmark[PoseLandmark.LEFT_SHOULDER]
